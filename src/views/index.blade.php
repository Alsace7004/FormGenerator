...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Welcome on FormBuilder</title>
        ...
        <style>
            ...
            .sidebar .side_links{
                ...
                margin: 30px 0px;/*TRBL TB RL*/
                padding: 0px 20px;/*TRBL TB RL*/
            }
            .sidebar .side_links li a{
                display: flex;
                align-items: center;
                border: 1px solid yellow;
                margin: 6px 0px;/*TRBL TB RL*/
                border-radius: 5px;
                padding: 7px 16px 7px 12px;/*TRBL TB RL*/
                transition: all .3s ease;
                color: #fff;
            }
            .sidebar .side_links li a:hover{
                background: #97BC62;
                color: #fff;
            }
            .content{
